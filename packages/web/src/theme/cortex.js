...
/**
 * cortex theme — built by `npx astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { cortexTheme } from './cortex';
 *   import './cortex.css';
 */
export const cortexTheme = {
  ...
  tokens: {
    ...
    "--font-family-body": "\"Inter Variable\", -apple-system, system-ui, sans-serif",
    "--font-family-heading": "\"Inter Variable\", -apple-system, system-ui, sans-serif",
    ...
    "--color-background-surface": "light-dark(#FEFBFF, #1D1A21)",
    "--color-background-body": "light-dark(#F4EFF8, #131017)",
    "--color-background-card": "light-dark(#FEFBFF, #1D1A21)",
    "--color-background-popover": "light-dark(#FEFBFF, #322F36)",
    "--color-background-muted": "light-dark(#1D1A210D, #1D1A2180)",
    "--color-accent": "light-dark(#7431E0, #D1BCFF)",
    ...
    "--color-text-primary": "light-dark(#000000, #FDFBFF)",
    "--color-text-secondary": "light-dark(#342E39, #C9C4D3)",
    "--color-text-disabled": "light-dark(#958E9B, #615C69)",
    "--color-text-accent": "var(--color-accent)",
    "--color-on-dark": "#ffffff",
    "--color-on-light": "#111111",
    "--color-on-accent": "light-dark(#FFFFFF, #29207E)",
    ...
    "--color-icon-primary": "light-dark(#000000, #FDFBFF)",
    "--color-icon-secondary": "light-dark(#342E39, #C9C4D3)",
    "--color-icon-disabled": "light-dark(#958E9B, #615C69)",
    ...
    "--color-border": "light-dark(#1D1A2133, #F2EFF933)",
    "--color-border-emphasized": "light-dark(#7B7581, #797582)",
    "--color-skeleton": "light-dark(#B0A8B6, #494551)",
    ...
    "--color-track": "light-dark(#B0A8B6, #494551)",
    "--radius-chat": "25px"
  },
  localTokens: {
  ...
  __localTokenLineage: ["neutral","cortex"],
  components: {
    "heading": {
      "level:1": {
