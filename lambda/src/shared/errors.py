...
class ResourceNotFoundError(CortexError):
    ...
    def __init__(self, resource_type: str = "Resource", code: ErrorCode = ErrorCode.RESOURCE_NOT_FOUND):
        super().__init__(
            code=code,
...
class RecoveryCodeInvalidError(CortexError):
    ...
    def __init__(self, message: str = "Recovery code is invalid or already used"):
        super().__init__(
            code=ErrorCode.RECOVERY_CODE_INVALID,
            message=message,
            status_code=401
        )
...
class VaultSaltNotFoundError(CortexError):
    ...
    def __init__(self, message: str = "Vault salt not found"):
        super().__init__(
            code=ErrorCode.VAULT_SALT_NOT_FOUND,
            message=message,
            status_code=404
        )
